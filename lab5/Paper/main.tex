...
Как видно из графиков, теперь фурье образы максимально близки к истинным. При  этом комбинированный метод работает быстрее численного интегрирования и точнее быстрого преобразования.
\newpage
