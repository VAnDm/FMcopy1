...
На данных графиках видно, что функция, полученнная обратным преобразованием от произведения передаточной функции на Фурье-образ зашумлённого сигнала, в среднем по модулю меньше чем отфильтрованный сигнал, хотя имеет ту же форму.
\clearpage
\begin{figure}[H]
    \centering
