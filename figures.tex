...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{images/ALL_T15_V100_dt0.010_dv0.100_signal.png}
    \caption{Восстановление сигнала: $T=15$, $dt=0.01$.}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{images/ALL_T15_V100_dt0.010_dv0.100_spectrum.png}
    \caption{Сравнение спектров: $V=100$, $dv=0.1$.}
\end{figure}
